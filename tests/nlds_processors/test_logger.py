...
def test_callback(debug_root_logger, caplog, default_logger, default_rmq_method, 
    ...
    default_rmq_logmsg_dict[rmqp.MSG_DETAILS][rmqp.MSG_LOG_TARGET] = 'nlds.root'
    ...
    default_rmq_logmsg_dict[rmqp.MSG_DETAILS][rmqp.MSG_LOG_TARGET] = 'test'
    routed_body = json.dumps(default_rmq_logmsg_dict)
    default_logger.callback(None, custom_method, None, routed_body, None)
