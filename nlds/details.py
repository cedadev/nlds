...
from typing import NamedTuple, Optional, List, Dict, TypeVar
...
class Retries(BaseModel):
    ...
    def from_dict(cls, dictionary: Dict[str, str]):
        ...
        return cls(
            count=dictionary["retries"]["count"],
            reasons=dictionary["retries"]["reasons"]
        )
