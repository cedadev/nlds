...
async def get(token: str = Depends(authenticate_token),
    ...
    # logic for user/group query verification. Do we want to prevent the 
    # querying of users other than themselves.
    ...
    msg_dict = {
        RMQP.MSG_DETAILS: {
            ...
            RMQP.MSG_USER_QUERY: query_user,
            RMQP.MSG_GROUP_QUERY: query_group,
        },
        RMQP.MSG_DATA: {},
